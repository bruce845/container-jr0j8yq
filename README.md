...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jr0j8yq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jr0j8yq.containers.anotherwebservice.com/
...
```
git clone git@github.com:bruce845/container-jr0j8yq.git
cd container-jr0j8yq
```
...
```
docker attach container-jr0j8yq
```
